            ...
            <form method="post" action=" {{ url('user-store') }} ">
                <div class="card shadow mb-4">
                    <div class="car-header bg-danger pt-2">
                        <div class="card-title font-weight-bold text-white text-center"> Registration </div>
                    </div>
...
<div class="form-group">
                            ...
                            <input type="file" name="profile_pic" id="last_name" class="form-control" value="{{ old('last_name') }}"/>
                            {!! $errors->first('last_name', '<small class="text-danger">:message </small>') !!}
                        </div>
...
<div class="form-group">
                            ...
                            <input type="text" name="address" id="last_name" class="form-control" placeholder="Enter Last Name" value="{{ old('last_name') }}"/>
                            {!! $errors->first('last_name', '<small class="text-danger">:message </small>') !!}
                        </div>
...
<div class="form-group">
							...
							<input type="text" name="city" id="last_name" class="form-control" placeholder="Enter Last Name" value="{{ old('last_name') }}"/>
                              {!! $errors->first('last_name', '<small class="text-danger">:message </small>') !!}
                        </div>
...
<div class="form-group">
                            ...
                            <input type="text" name="state" id="last_name" class="form-control" placeholder="Enter Last Name" value="{{ old('last_name') }}"/>
                            {!! $errors->first('last_name', '<small class="text-danger">:message </small>') !!}
                        </div>
...
<div class="form-group">
							...
							<input type="text" name="pincode" id="last_name" class="form-control" placeholder="Enter Last Name" value="{{ old('last_name') }}"/>
                              {!! $errors->first('last_name', '<small class="text-danger">:message </small>') !!}
                        </div>
